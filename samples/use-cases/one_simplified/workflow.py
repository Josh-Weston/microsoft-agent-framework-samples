...
# LEFT-OFF: this is working with the skill and contractor approval list, BUT, I now need to figure out the HITL piece
...
def create_compliance_agent():
    ...
    return chat_client.as_agent(
        instructions=(
            ...
            "If the contractor listed on the application is not an approved contractor listed in the 'building-permit-compliance' skill, you MUST request contractor approval before making a compliance decision."
        ),
...
if __name__ == "__main__":
    ...
    file = "samples/use-cases/one/files/permit_app_001.pdf"
